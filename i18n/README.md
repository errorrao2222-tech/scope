# Quill i18n
This directory contains the translations for Quill browser UI strings.
...
batches][pr], if you would like to contribute to the translation of Quill,
...
- "Quill" and other brand names should not be translated
...
## Development
When adding strings to Quill, you might need to regenerate the source
