# Scope i18n
This directory contains the translations for Scope browser UI strings.
...
batches][pr], if you would like to contribute to the translation of Scope,
...
- "Scope" and other brand names should not be translated
...
## Development
When adding strings to Scope, you might need to regenerate the source
